...
- Entrenamiento y evaluación de clasificador baseline `LogReg` binario.
...
Resumen: Entrega H1 sobre ChestX-ray14: normal_vs_pathological, features=statistical, classifier=logreg, train=8, val=2, avg_val_confidence=<valor>, preprocessing=resize(512x512), metrics=ClassificationMetrics(...)
```
